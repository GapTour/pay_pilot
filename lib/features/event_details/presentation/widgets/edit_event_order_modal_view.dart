...
class EditEventOrderModalView extends StatefulWidget {
  ...
  @override
  State<EditEventOrderModalView> createState() =>
      _EditEventOrderModalViewState();
}

class _EditEventOrderModalViewState extends State<EditEventOrderModalView> {
