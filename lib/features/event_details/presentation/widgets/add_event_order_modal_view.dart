...
class AddEventOrderModalView extends StatefulWidget {
  ...
  @override
  State<AddEventOrderModalView> createState() => _AddEventOrderModalViewState();
}

class _AddEventOrderModalViewState extends State<AddEventOrderModalView> {
